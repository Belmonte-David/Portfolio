        ...
        return (
            <div className='content'>
                ...
                <br/>
                    ...
                    <p>Ces 5 mois ont été très intensifs mais passionnants ! J'ai appris beaucoup de choses et après avoir effectuer un stage de 5 mois sur une autre technologie (React Native) j'ai hâte de continuer à solidifier toutes les bases que j'ai pu acquérir ! Je suis d'ailleurs actuellement en recherche de CDI en tant que développeur web junior dès mi-février, donc n'hésitez pas à me contacter : Je serai enchanté de faire votre connaissance ! </p>
                </div>
            </div>
        );
    }
