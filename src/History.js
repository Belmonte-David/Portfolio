        ...
        return (
            <div className='content'>
                ...
                <br/>
                    ...
                    <p>J'ai donc décidé d'intégrer, au mois de février, une formation de 5 mois au sein de la Wild Code School. Cette école nous apprend le métier de développeur web : Nous choisissons un langage (pour ma part, le JavaScript) et un framework (j'ai choisi la librairie 'React'). Nous avons aussi un certain nombre de cours sur du back-end (NodeJs, Mysql, Express), l'agilité (SCRUM), etc.</p>
